...
public class QuadTree {
     ...
     *
     * @return {Varunpat.Varunpat.QuadTree.QuadTree.Node} The root node.
     */
     ...
     * @return {Array.<Varunpat.QuadTree.Point>} Array of coordinates.
     */
     ...
     * @return {Varunpat.QuadTree.QuadTree} A clone of the tree.
     */
     ...
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} node The current node.
     * @param {function(Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node)} fn The function to call
     ...
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} node The node to search in.
     * @param {number} x The x-coordinate of the point to search for.
     * @param {number} y The y-coordinate of the point to search for.
     * @return {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} The leaf node that matches the target,
     ...
     * @param {.Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} parent The parent to insert the point
     *     into.
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.QuadTree.Point} point The point to insert.
     ...
     * the correct child.
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} node The node to split.
     * @private
     */
     ...
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} node The node to balance.
     * @private
     */
     ...
     * coordinate.
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} parent The node.
     * @param {number} x The x-coordinate to look for.
     * @param {number} y The y-coordinate to look for.
     * @return {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} The child quadrant that contains the
     *     point.
     * @private
     */
     ...
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.Varunpat.QuadTree.QuadTree.Node} node The node to set the point for.
     * @param {Varunpat.QuadTree.QuadTree.Varunpat.QuadTree.Point} point The point to set.
     * @private
     */
